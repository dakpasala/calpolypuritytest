  ...
  return (
    <main className="bg-yellow-100 min-h-screen flex justify-center items-start px-4 py-10">
      <div className="bg-[#fff9ec] p-8 rounded-lg shadow-lg max-w-4xl w-full">
        ...
        <h3 className="text-2xl font-bold font-serif text-black mb-2 text-center">Share the Cal Poly Purity Test</h3>
        ...
        <div className="flex justify-center gap-4 my-4">
          <a
            href="https://twitter.com/intent/tweet?text=Just+did+the+Cal+Poly+Purity+Test!+https://your-site.com"
            target="_blank"
          ...
          <a
            href="https://api.whatsapp.com/send?text=Try+the+Cal+Poly+Purity+Test!+https://your-site.com"
            target="_blank"
            rel="noopener noreferrer"
            onClick={handleSocialShare}
