...
const questions = [
  ...
  "Missed a final because you didn’t want to take it?",
  ...
  "Hiked the 'P' or Bishop Peak",
  "Waited in line for SLO DoCo past midnight?",
  ...
  "Prayed for a parking spot behind the rec?",
  ...
  "Drank at Saint Fratty's?",
  "Called campus food 'mid' at least once?",
  "Left mid-class to go to the beach?",
  ...
  "Had to walk from PCV or Yosemite/Yak area to class?",
  "Gone to a frat/sororiety date dash?",
